...
HEPMC_INPUT=/work/omunkombwe/k4RecTracker/MyFiles/ee_z_mumu1000.hepmc
...
ddsim --steeringFile $STEERING_FILE \
      ...
      --random.seed 42 \
      --numberOfEvents 1000 \
      --outputFile MyFiles/ee_z_mumu0.root 
    
k4run Tracking/test/testTrackFinder/runTestTrackFinder.py --inputFile MyFiles/ee_z_mumu0.root --outputFile MyFiles/ee_z_mumu1.root --modelPath $MODEL_PATH --tbeta $TBETA --td $TD

k4run Tracking/test/testTrackFitter/runTestTrackFitter.py --inputFile MyFiles/ee_z_mumu2.root --outputFile MyFiles/ee_z_mumu2.root
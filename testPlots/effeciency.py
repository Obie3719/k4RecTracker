...
if __name__ == "__main__":
    ...
    parser.add_argument("--tracks", default="Fitted_tracks_electron",
                        help="track collection name")
    parser.add_argument("--mc", default="MCParticles",
                        help="MCParticles collection name")
    parser.add_argument("--pdg", type=parse_pdg_arg, default=parse_pdg_arg("11"),
    ...
    parser.add_argument("--out", default="eff_vs_pt_ezm.png",

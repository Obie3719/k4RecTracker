...
MAX_EVENTS = 10
OUTPUT_DIR = "./event_displays_digi_vs_sim_c/"
...
reader = get_reader("/ceph/omunkombwe/pi_Barrel/deg90/fit_pi_P0.2-10.0GeV_theta90deg_nev100000_merged.root")
...
for iev, event in enumerate(events):
    ...
    plt.suptitle(f"Event {iev} – DCH: Digitized vs Simulated Hits", fontsize=14)
    plt.tight_layout()

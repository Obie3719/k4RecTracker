...
ddsim --steeringFile $STEERING_FILE \
      ...
      --random.seed 42 \
      --numberOfEvents 100 \
      --outputFile output_rootFiles/ee_z_bb0.root 
    
k4run Tracking/test/testTrackFinder/runTestTrackFinder.py --inputFile output_rootFiles/ee_z_bb0.root --outputFile output_rootFiles/ee_z_bb1.root --modelPath $MODEL_PATH --tbeta $TBETA --td $TD

k4run Tracking/test/testTrackFitter/runTestTrackFitter.py --inputFile output_rootFiles/ee_z_bb1.root --outputFile output_rootFiles/ee_z_bb2.root
